...
const CountriesPage = () => {
  return (
    <div className="container mx-auto py-12 md:py-16 px-4 md:px-6 max-w-6xl"> {/* Adjust max-width as needed */}
      {/* Header Section */}
      <div className="text-center mb-16 md:mb-20">
        <h1 className="text-4xl md:text-6xl font-extrabold mb-6 text-green-700 transition-colors duration-300">
          Nigeria
        </h1>
        <div className="flex justify-center">
          <Image
            src={"https://ik.imagekit.io/ufokswd8x/" + "Article" + "six/Countries/Nigeria.png?updatedAt=1720782350360"}
            alt="Nigeria Image"
            width={0}
            height={0}
            sizes="100vw"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        {/* Economy Section */}
        <div className="bg-white p-6 md:p-8 shadow-sm rounded-lg transition-shadow hover:shadow-md">
          <h2 className="text-2xl md:text-4xl font-semibold mb-4 text-green-700">Economy</h2>
        ...
        <div className="bg-white p-6 md:p-8 shadow-sm rounded-lg transition-shadow hover:shadow-md">
          <h2 className="text-2xl md:text-4xl font-semibold mb-4 text-green-700">Environment and Sustainability Initiatives</h2>
          <p className="text-base md:text-lg text-gray-700">
        ...
        <div className="bg-white p-6 md:p-8 shadow-sm rounded-lg transition-shadow hover:shadow-md">
          <h2 className="text-2xl md:text-4xl font-semibold mb-4 text-green-700">Cultural Highlights</h2>
          <p className="text-base md:text-lg text-gray-700">
        ...
        {/* Tourism Section */}
        <div className="bg-white p-6 md:p-8 shadow-sm rounded-lg transition-shadow hover:shadow-md">
          <h2 className="text-2xl md:text-4xl font-semibold mb-4 text-green-700">Tourism</h2>
          <p className="text-base md:text-lg text-gray-700">
        ...
        <div className="bg-white p-6 md:p-8 shadow-sm rounded-lg transition-shadow hover:shadow-md">
          <h2 className="text-2xl md:text-4xl font-semibold mb-4 text-green-700">Current Projects</h2>
          <p className="text-base md:text-lg text-gray-700">
        ...
        <div className="bg-white p-6 md:p-8 shadow-sm rounded-lg transition-shadow hover:shadow-md">
          <h2 className="text-2xl md:text-4xl font-semibold mb-4 text-green-700">Investment Opportunities</h2>
          <p className="text-base md:text-lg text-gray-700">
