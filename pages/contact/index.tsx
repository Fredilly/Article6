...
const ContactPage = () => {
  return (
    <div className="container mx-auto py-12 md:py-16 px-4 md:px-6 max-w-4xl"> {/* Adjust max-width as needed */}
      {/* Header Section */}
      ...
      <div className="mb-12 md:mb-16">
        <h2 className="text-2xl md:text-4xl font-semibold mb-4 text-green-700 text-center">Get in Touch</h2>
        <form className="bg-white p-6 md:p-8 shadow-sm rounded-lg mx-auto max-w-2xl">
          <div className="mb-4">
      ...
      <div className="mb-12 md:mb-16">
        <h2 className="text-2xl md:text-4xl font-semibold mb-4 text-green-700 text-center">Our Office</h2>
        ...
        <div className="flex justify-center mb-4">
          <iframe
            ...
            allowFullScreen
            loading="lazy"
            className="rounded-lg shadow-sm w-full h-64 md:h-96"
          ></iframe>
        </div>
