    ...
    <div className="container mx-auto py-16 px-6 max-w-4xl"> {/* Consistent margins and width */}
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-lg text-gray-700">
          At Article6, we are committed to harnessing the power of technology and innovation to drive sustainability and environmental conservation. Our mission is to create a better future by developing and implementing solutions that make a real-world impact.
        </p>
      </div>
