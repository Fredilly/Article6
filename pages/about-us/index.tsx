...
const AboutUsPage = () => {
  return (
    <div className="container mx-auto py-12 md:py-16 px-4 md:px-6 max-w-4xl"> {/* Consistent margins and width */}
      {/* Header Section */}
      <div className="text-center mb-12 md:mb-16">
        <h1 className="text-4xl md:text-6xl font-extrabold mb-6 text-green-700">
          About Us
        </h1>
      ...
      <div className="mb-12 md:mb-16">
        <h2 className="text-2xl md:text-4xl font-semibold mb-4 text-green-700">Our Mission</h2>
        <p className="text-base md:text-lg text-gray-700">
      ...
      {/* Values Section */}
      <div className="mb-12 md:mb-16">
        <h2 className="text-2xl md:text-4xl font-semibold mb-4 text-green-700">Our Values</h2>
      ...
      {/* Team Section */}
      <div className="mb-12 md:mb-16">
        <h2 className="text-2xl md:text-4xl font-semibold mb-4 text-green-700">Meet Our Team</h2>
        <p className="text-base md:text-lg text-gray-700">
      ...
      {/* Vision Section */}
      <div className="mb-12 md:mb-16">
        <h2 className="text-2xl md:text-4xl font-semibold mb-4 text-green-700">Our Vision</h2>
        <p className="text-base md:text-lg text-gray-700">
